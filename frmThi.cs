...
namespace THITN
{
    public partial class frmThi : Form
    {
        ...
        private void sP_BAITHIGridControl_Click(object sender, EventArgs e)
        {
        ...
        private void frmThi_Load(object sender, EventArgs e)
        {
            ...
            if (Program.checkThiGV == false)
            {
                try
                {
                    String themDiem = "INSERT INTO BANGDIEM(MASV, MAMH, LAN, NGAYTHI) VALUES('" + Program.username + "','" + Program.mMaMH + "'," + Program.mLan + ",'" + Program.mNgayThi + "')";
        ...
        private void sP_BAITHIGridControl_Click_1(object sender, EventArgs e)
        {
        ...
        private void NopBai()
        {
            ...
            if(Program.checkThiGV == false)
            {
                try
                {
                    String UpdateDiem = "update BANGDIEM SET DIEM =" + diem + " WHERE MASV = '" + Program.username + "' AND MAMH = '" + Program.mMaMH + "' AND LAN =" + Program.mLan;
